...
class WC_PB_Top_Add_To_Cart {
	...
	public static function version_notice() {
	    echo '<div class="error"><p>' . sprintf( __( '<strong>WooCommerce Product Bundles &ndash; Top Add To Cart Button</strong> requires Product Bundles <strong>%s</strong> or higher.', 'woocommerce-product-bundles-top-add-to-cart-button' ), self::$req_pb_version ) . '</p></div>';
	}
